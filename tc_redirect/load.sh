...
then
        ...
        VETH_1=$1
        # compile
        clang -O2 -target bpf -c my_tc_l2_redirect_kern.c -o my_tc_l2_redirect_kern.o
	tc qdisc add dev ${VETH_1} clsact

	# redirect
	tc filter add dev ${VETH_1} ingress bpf da obj my_tc_l2_redirect_kern.o sec tc_ingress_redirect
